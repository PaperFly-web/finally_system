...
public class UserController {
     ...
     */
    @PostMapping("/list")
    //@RequiresPermissions("cslg:user:list")
   ...
   // @RequiresPermissions("cslg:user:info")
     ...
     */
    @PostMapping("/save")
    //@RequiresPermissions("cslg:user:save")
     ...
     */
    @PostMapping("/update")
    //@RequiresPermissions("cslg:user:update")
   ...
   // @RequiresPermissions("cslg:user:delete")
    ...
    */
    ...
    public void getAllUserExcel(HttpServletResponse response){
        ...
        MyFileUtil.downloadExcel(response,list,"user.xls");
